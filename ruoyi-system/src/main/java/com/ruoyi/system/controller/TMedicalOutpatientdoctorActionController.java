...
列表
     */
    @PreAuthorize("@ss.hasPermi('system:action:list')")
    @GetMapping("/list")
...
列表
     */
    @PreAuthorize("@ss.hasPermi('system:action:export')")
...
详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:action:query')")
    @GetMapping(value = "/{id}")
    public AjaxResult getInfo(@PathVariable("id") String id)
    {
        return AjaxResult.success(tMedicalOutpatientdoctorActionService.selectTMedicalOutpatientdoctorActionById(id));
    }
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:action:add')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:action:edit')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:action:remove')")
