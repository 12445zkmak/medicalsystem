<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="消费事项：检查CT、检验血常规..." prop="partname">
        <el-input
          v-model="queryParams.partname"
          placeholder="请输入消费事项：检查CT、检验血常规..."
          clearable
      ...
      <el-form-item label="${comment}" prop="opdoctorreceiverecordid">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:action:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:action:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="actionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="医生看病流程表id随机" align="center" prop="id" />
      <el-table-column label="消费事项：检查CT、检验血常规..." align="center" prop="partname" />
      <el-table-column label="事项数量" align="center" prop="partnumber" />
      <el-table-column label="1门诊患者2住院患者" align="center" prop="persontype" />
      <el-table-column label="单价" align="center" prop="partmoney" />
      <el-table-column label="1检查2检验3处置" align="center" prop="type" />
      <el-table-column label="${comment}" align="center" prop="opdoctorreceiverecordid" />
...
对话框 -->
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="消费事项：检查CT、检验血常规..." prop="partname">
          <el-input v-model="form.partname" placeholder="请输入消费事项：检查CT、检验血常规..." />
        </el-form-item>
        <el-form-item label="事项数量" prop="partnumber">
        ...
        <el-form-item label="${comment}" prop="opdoctorreceiverecordid">
          <el-input v-model="form.opdoctorreceiverecordid" placeholder="请输入${comment}" />
        </el-form-item>
      </el-form>
...
列表 */
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/action/export', {
        ...this.queryParams
