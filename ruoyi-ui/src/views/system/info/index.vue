<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="退卡时间" prop="returntime">
        <el-date-picker clearable
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="门诊卡信息表id 随机 " align="center" prop="id" />
      ...
      <el-table-column label="退卡时间" align="center" prop="returntime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.returntime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="状态1启用2挂失3作废4退卡" align="center" prop="status" />
