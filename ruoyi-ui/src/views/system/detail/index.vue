<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="消费事项：检查、药品.." prop="partname">
        <el-input
          v-model="queryParams.partname"
          placeholder="请输入消费事项：检查、药品.."
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="detailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="患者费用明细表id随机" align="center" prop="id" />
      <el-table-column label="账单id" align="center" prop="billid" />
      <el-table-column label="消费事项：检查、药品.." align="center" prop="partname" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="消费事项：检查、药品.." prop="partname">
          <el-input v-model="form.partname" placeholder="请输入消费事项：检查、药品.." />
        </el-form-item>
        <el-form-item label="事项数量" prop="partnumber">
